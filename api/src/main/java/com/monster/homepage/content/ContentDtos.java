...
public final class ContentDtos {
    ...
    public record PostRequest(@NotBlank @Size(max = 180) String title, @Size(max = 180) String slug, String summary, @NotBlank String content, String coverImageUrl, List<String> tags, @Size(max = 120) String series, ContentStatus status, boolean featured) {}
    public record NoteRequest(@NotBlank @Size(max = 180) String title, @Size(max = 180) String slug, String summary, @NotBlank String content, @Size(max = 80) String category, List<String> tags, ContentStatus status, UUID parentId, @Min(0) Integer sortOrder) {}
